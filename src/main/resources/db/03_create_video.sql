...
(
    ...
    en_title       varchar(32),
    other_titles   varchar(128),
    cover          varchar(64)                        not null,
    genres         varchar(16)                        not null,
    regions        varchar(16)                        not null,
    languages      varchar(16)                        not null,
    release_date   date                               not null,
    runtimes       varchar(16)                        not null,
...
(
    ...
    constraint uk_season_imdb_id unique index (imdb_id)
